...
![[Pasted image 20230830160500.png]]
...
![[Pasted image 20230830161920.png]]
...
所谓的由客户端决定，是通过配置参数来定的。参考[[Hadoop3.x集群安装#3.2.2 修改配置文件|配置文件]]
如，读取hdfs-default.xml的块大小（dfs.blocksize）和副本数（dfs.replication）配置
...
增删查改操作
见**bigdata项目**的下的**hadoop-hdfs**下的com.bigdata.hdfs.HdfsClientTestMian

 **项目实战：**
见**bigdata项目**的下的**hadoop-hdfs**下的com.bigdata.datacollect.DataCollectMain
```txt
...
见**bigdata项目**的下的**hadoop-hdfs**下的com.bigdata.wordcount.HdfsWordcountMain
```txt
单词统计
...
![[Drawing 2023-09-04 10.42.56.excalidraw]]

#### 3.1.1 NameNode和SecondaryNameNode
...
2. 一分钟检查一次操作次数，当操作次数达到一百万时，SecondaryNameNode一次
...
![[Drawing 2023-09-04 12.27.05.excalidraw]]
...
![[Drawing 2023-09-04 13.20.10.excalidraw]]
### 3.4 DataNode的工作机制

![[Drawing 2023-09-04 13.46.00.excalidraw]]
